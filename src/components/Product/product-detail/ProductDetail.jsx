...
export const ProductDetail = () => {
    ...
    const fetchData = () => {
        setFetching(true);
        axios.get('http://localhost:3050/api/products/').then((res) => {
                ...
                {productDetail.map((product) => (
                            ...
                            <div className="preview col-md-6">
                                <div className="preview-pic tab-content">
                                    <div className="tab-pane active" id="pic-1">
                                        <img className="main-image" src={product.srcImage} />
                                    </div>
                  ...
                  <li><a data-target="#pic-5" data-toggle="tab"><img src={product.images} /></a></li>
                            ...
                            <div className="details col-md-6">
                                ...
                                <p className="product-description">{product.decription}</p>
                                <h4 className="price">
                                    Giá bán: <span> {product.price} VND</span>
                                </h4>
                                <p className="vote">
                                    <strong>91%</strong>người mua thích sản phẩm này!{' '}
                  ...
                  <span className="size" data-toggle="tooltip" title="xtra large">xl</span>
                                ...
                                <div className="product-size">
                                    <div className="row">
                                        <div className="col-md-5">
                                            <label htmlFor="size" className="sizes">
                                                Size
                                            </label>
                                ...
                                <div className="product-brand all-detail">
                                    ...
                                    <div className="brand information">{product.brand}</div>
                                </div>
