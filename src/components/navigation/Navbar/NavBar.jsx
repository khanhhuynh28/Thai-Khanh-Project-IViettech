      ...
      <div className="navBar">
        ...
        <div className="nav">
          <button className="cards">
            ...
            <div className="describe"><p> Xe cộ</p></div>
          </button>
          <button className="cards">
          ...
          <button className="cards">
            ...
            <div className="describe"><p>Tủ lạnh, máy giặt</p></div>
          </button>
        </div>
      </div>
    </div>
